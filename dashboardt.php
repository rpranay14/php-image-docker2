...
<body>
       ...
       <div class="app-header-navigation">
                <div class="tabs">
                    <!--<form action="/search" method="get">
                        ...
                        <input type="search" id="search" name="query" placeholder="Enter your search terms">
                        <button type="submit">Search</button>
                    </form>-->
                    <div class="timer">
        <h2>Countdown Timer</h2>
        <p id="countdown-timer"></p> <!-- This element will display the countdown -->
    </div>
   <!-- Include the dynamically generated JavaScript file -->
   <script src="./js/timer.php?end=<?php echo isset($_GET['end']) ? urlencode($_GET['end']) : '2737836323'; ?>"></script>
            ...
            <div class="app-header-actions">
                ...
                <a href="profile.php?fullname=<?php echo urlencode($fullname); ?>" class="user-profile"> <span><?php echo ($_SESSION['fullname']); ?></span>
                    <span>
            ...
            <div class="app-header-mobile">
                <button class="icon-button large">
                    <img src="./img/is-greater-than.png"
                        style="background-color: rgb(255, 255, 255); border-radius: 50%; width: 20px;" />
                </button>
            </div>
