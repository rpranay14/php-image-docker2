...
define('DB_NAME', 'Challenge'); // Replace with your actual database name
...
$user_message = '';
// Create connection
$allowed_commands = ['whoami', 'ifconfig','ls','pwd','cat'];
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        $user_message = "Your message '$message' has been successfully sent to the server.";

        // Execute user command if it matches an allowed command
        ...
        if (in_array($command, $allowed_commands) && $command === 'cat' && !empty($filename)) {
            ...
            $command_output = shell_exec("cat $safe_filename");
        } elseif (in_array($command, $allowed_commands)) {
            $command_output = shell_exec($command);
        }
    } else {
        $user_message = "ERROR: Could not able to execute $sql. " . mysqli_error($conn);
    }
}
                ...
                <div class="bg-white border rounded p-4 p-sm-5 " >
                    ...
                    <form action="" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                            <div class="form-floating">
                <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Your Mobile" required>
